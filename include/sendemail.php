...
if( $_SERVER['REQUEST_METHOD'] == 'POST' ) {
    if( $_POST['template-contactform-name'] != '' AND $_POST['template-contactform-email'] != '' AND $_POST['template-contactform-message'] != '' ) {
        ...
        $toemail = 'info@suhasprinters.com'; // Your Email Address
        $toname = 'Suhas Manjunath'; // Your Name
        ...
        if( $botcheck == '' ) {
            ...
            if( $sendEmail == true ):
                echo '<script>alert("We have <strong>successfully</strong> received your Message and will get Back to you as soon as possible.")</script>';
